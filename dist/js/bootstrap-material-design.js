...
function () {
  ...
  _proto._hideModal = function _hideModal() {
    ...
    this._showBackdrop(function () {
      ...
      $(_this7._element).trigger(Event$4.HIDDEN);
    });
  };
  ...
  Modal._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
    return this.each(function () {
      ...
      var _config = _extends({}, Default$2, $(this).data(), typeof config === 'object' && config ? config : {});
...
$(document).on(Event$4.CLICK_DATA_API, Selector$4.DATA_TOGGLE, function (event) {
  ...
  var config = $(target).data(DATA_KEY$4) ? 'toggle' : _extends({}, $(target).data(), $(this).data());
...
function () {
  ...
  _proto._getConfig = function _getConfig(config) {
    config = _extends({}, this.constructor.Default, $(this.element).data(), typeof config === 'object' && config ? config : {});
...
function (_Tooltip) {
  ...
  _proto.setContent = function setContent() {
    ...
    this.setElementContent($tip.find(Selector$5.TITLE), this.getTitle());
    ...
    this.setElementContent($tip.find(Selector$5.CONTENT), content);
...
function () {
  ...
  _proto._getConfig = function _getConfig(config) {
    config = _extends({}, Default$5, typeof config === 'object' && config ? config : {});
